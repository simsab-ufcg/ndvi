...
struct NDVITOAGenerate{
    ...
    NDVITOAGenerate(ldouble _sun_elevation, Tiff _band_red, Tiff _band_nir, Tiff _band_bqa);
    void processNDVI(int number_sensor, ldouble dist_sun_earth, Tiff ndvi, vector<ldouble> param_band_red, vector<ldouble> param_band_nir);
